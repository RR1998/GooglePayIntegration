...
import com.example.android_quickstart.R
        ...
        Column(
            ...
            if (payUiState !is PaymentUiState.NotStarted) {
                PayButton(
                    ...
                    /**
                     * PaymentsUtil.allowedPaymentMethods is a buildup of all parameters required to do
                     * a transaction such as
                     * Gateway that could be like an alias for a merchant
                     * GatewayMerchantId unique required merchantId whenever it gets recognized
                     */
